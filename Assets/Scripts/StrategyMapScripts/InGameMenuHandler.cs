   ...
   // [SerializeField] private Text sucesionSizeTxt;
    ...
    public void UpdateTerritoryMenu()
    {
        if (selectedTerritory.TypePlayer == Territory.TYPEPLAYER.PLAYER)
        {
            ...
            levelTxt[0].text = "Level " + selectedTerritory.GoldMineTerritory.Level.ToString();
            levelTxt[1].text = "Level " + selectedTerritory.SacredPlaceTerritory.Level.ToString();
            levelTxt[2].text = "Level " + selectedTerritory.FortressTerritory.Level.ToString();
            levelTxt[3].text = "Level " + selectedTerritory.BarracksTerritory.Level.ToString();
