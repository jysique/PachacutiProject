...
public class TutorialMoveSword : Tutorial
{
    ...
    public override void CheckTutorial()
    {
        ...
        if (ug != null && ug.UnitCombat.UnitType == "Swordsman" && ug.TypePlayer == Territory.TYPEPLAYER.PLAYER)
        {
            ...
            ug = square.UnitGroup;
            if (ug != null && ug.UnitCombat.UnitType == "Archer")
            {
...
public class TutorialDefendSword : Tutorial
{
    ...
    public override void CheckTutorial()
    {
        ...
        if (ug1 != null && ug1.UnitCombat.UnitType == "Sword" && ug1.Defense)
        {
            x = 1;
        }
        ...
        if (ug2 != null && ug2.UnitCombat.UnitType == "Archer" && ug2.Defense)
        {
            x = 2;
        }
        if (x==2)
